...
void Canvas::draw_text(const TTFFontPtr& font, const std::string& text, const Vector& position, FontAlignment alignment, int layer, const Color& color) {
	// font.draw_text(*this, text, position, alignment, layer, color);
	font->draw_text(*this, text, position, alignment, layer, color);
}

void Canvas::draw_center_text(const TTFFontPtr& font, const std::string& text, const Vector& position, int layer, const Color& color) {
